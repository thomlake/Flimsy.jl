...
function check_ml_single()
    ...
    X1, Yid1 = rand(Flimsy.Demo.MoG(2, n_features[1]), n_samples)
    X2, Yid2 = rand(Flimsy.Demo.MoG(2, n_features[2]), n_samples)
    X3, Yid3 = rand(Flimsy.Demo.MoG(2, n_features[3]), n_samples)
    X4, Yid4 = rand(Flimsy.Demo.MoG(2, n_features[4]), n_samples)
...
function fit()
    ...
    D = [Flimsy.Demo.MoG(2, n_features[i]) for i = 1:n_classes]
